...
def main():
    ...
    # experiment
    parser.add_argument("--out_path", type=str, default="/home/sangfor/Videos/libero_pro_pi05/action_entropy_debug", help="saved video results")
    ...
    # algorithm related
    parser.add_argument("--chunk_size_selector", type=str, default="fixed_5", help="whether to save video results")
    ...
    parser.add_argument("--task_suite_name", type=str, default="libero_object_temp_x0.1", help="Options: libero_spatial, libero_object, libero_goal, libero_10, libero_90")
